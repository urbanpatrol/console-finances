...
for (var i = 0; i < finances.length; i++) { // starting with the first element over the array
    total += finances[i][1]; // for each iteration, the second element is added to the total
}
console.log(total);
...
for (var i = 1; i < finances.length; i++) {
    totalChange += finances[i][1] - finances[i - 1][1]; //starting from the second element, the difference between the value of the current element and the previous element and added to totalChange
}
...
// * The greatest increase in profits (date and amount) over the entire period.
    ...
    for (var i = 1; i < finances.length; i++) {
      var profit = finances[i][1] - finances[i - 1][1];
...
// * The greatest decrease in losses (date and amount) over the entire period.
    ...
    for (var i = 1; i < finances.length; i++) {
      var profit = finances[i - 1][1] - finances[i][1];
